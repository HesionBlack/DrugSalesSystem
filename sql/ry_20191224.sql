/*
 ...
 Source Schema         : drugsales

 Target Server Type    : MySQL
 Target Server Version : 80018
 File Encoding         : 65001

 Date: 24/12/2019 17:08:53
*/
...
-- ----------------------------
BEGIN;
INSERT INTO `QRTZ_SCHEDULER_STATE` VALUES ('RuoyiScheduler', 'bogon1577178459207', 1577178524250, 15000);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `QRTZ_TRIGGERS` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME1', 'DEFAULT', 'TASK_CLASS_NAME1', 'DEFAULT', NULL, 1577178460000, -1, 5, 'PAUSED', 'CRON', 1577178459000, 0, NULL, 2, '');
INSERT INTO `QRTZ_TRIGGERS` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME2', 'DEFAULT', 'TASK_CLASS_NAME2', 'DEFAULT', NULL, 1577178465000, -1, 5, 'PAUSED', 'CRON', 1577178459000, 0, NULL, 2, '');
INSERT INTO `QRTZ_TRIGGERS` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME3', 'DEFAULT', 'TASK_CLASS_NAME3', 'DEFAULT', NULL, 1577178460000, -1, 5, 'PAUSED', 'CRON', 1577178459000, 0, NULL, 2, '');
COMMIT;
...
CREATE TABLE `sys_oper_log` (
  ...
  PRIMARY KEY (`oper_id`)
) ENGINE=InnoDB AUTO_INCREMENT=129 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作日志记录';
...
INSERT INTO `sys_role` VALUES (2, '普通角色', 'common', 2, '2', '0', '0', 'admin', '2018-03-16 11:33:00', 'admin', '2019-12-24 11:07:32', '普通角色');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', '2019-12-24 16:57:14', 'admin', '2018-03-16 11:33:00', 'ry', '2019-12-24 16:57:14', '管理员');
...
INSERT INTO `sys_user` VALUES (100, 103, 'fr', '阳光', '00', '1746991605@qq.com', '15222222222', '0', '', 'a560f6b30befae4c0eddfe92873a7374', 'c2a440', '0', '0', '', NULL, 'admin', '2019-12-24 09:49:15', '', NULL, NULL);
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user_online` VALUES ('09a89bbc-ac5d-450e-9d68-e0b4c4bd2f0b', 'admin', '研发部门', '127.0.0.1', '内网IP', 'Firefox 7', 'Mac OS X', 'on_line', '2019-12-24 16:57:06', '2019-12-24 17:01:50', 1800000);
COMMIT;
